...
<html lang="en">
  <head>
    ...
    <title>Beasiswa | Logika Fuzzy</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center" style="color:white;">
          <h2>MOCH YOGI FIRMANSYAH | 20051397044</h2>
          <h5>MENENTUKAN PEROLEHAN BEASISWA MENGGUNAKAN METODE FUZZY TSUKAMOTO</h5>
          <hr>
        </div>
        ...
        <div class="col-md-12 text-center">
          <button class="btn btn-primary" data-toggle="modal" data-target="#modal-hitung">HITUNG BEASISWA</button>
        </div>
      </div>
